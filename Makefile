...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2018/02/28 21:23:58 by dkrause-          #+#    #+#              #
#    Updated: 2018/02/28 21:24:01 by dkrause-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_putnbr.c ft_putchar.c ft_putstr.c ft_isalpha.c ft_atoi.c ft_bzero.c \
	   ...
	   ft_ptr_overlap.c ft_calc_wrds.c ft_sqrt.c ft_nbrlen.c ft_isnegative.c\
	   ft_isspace.c\
	   
NAME = libft.a

OBJ =  ft_putnbr.o ft_putchar.o ft_putstr.o ft_isalpha.o ft_atoi.o ft_bzero.o \
	   ...
	   ft_ptr_overlap.o ft_calc_wrds.o ft_sqrt.o ft_nbrlen.o ft_isnegative.o\
	   ft_isspace.o\
